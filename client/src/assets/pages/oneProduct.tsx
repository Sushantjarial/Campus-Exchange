    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-6  bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900  animate-gradient-move">
                ...
                <div className="grid col-span-4 mt-4 mb-4 p-4 ">
                ...
                <div className="flex flex-col space-y-10 col-span-2 mt-8 pl-8 ">
                    <div className="h-fit w-3/4   flex flex-col  items-start bg-gray-900   text-white px-4 rounded-xl">
                    ...
                    <div className="h-fit w-3/4  bg-gray-70 flex flex-col  px-4  bg-gray-900 text-white space  rounded-xl ">
                    ...
                    <div
                    className="text-blue-400 pl-2">{product?.user.firstName+" "+product?.user.lastName}
                    </div>
                    </div>
                    </div>
                </div>
