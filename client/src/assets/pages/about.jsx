...
export default function About() {
    return (
      <section id="about-section" className="bg-white dark:bg-gray-800 p-16 text-center pt-48 pb-40">
        <h2 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-gray-200 mb-8 font-sans">
          About Campus Exchange
        </h2>
        <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed font-serif">
