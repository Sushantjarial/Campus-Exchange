...
//         // Implement search functionality or navigation as needed
//     };
...
//             {/* Search and Filter Section - Search Bar and Button Visible Only on Small Screens */}
//             <div className="bg-gray-100 dark:bg-gray-900 p-4 text-center">
//                 {/* Search Bar and Button for Small Screens */}
//                 <div className="flex justify-center items-center space-x-2 w-full sm:w-1/2 mx-auto md:hidden">
//                     <input
//                         type="text"
