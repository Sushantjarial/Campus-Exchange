 ...
 setProducts( products?.filter((product)=>{
    ...
    return (
        <div className=' min-h-screen bg-gray-900 '>
            ...
            <div className=" bg-gray-900 sm:pt-16 p-4">
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="w-full flex sm:hidden items-center space-x-2">
                        <input
                            ...
                            className="flex-grow p-2 rounded-lg border border-gray-700"
                            value={searchTerm}
          ...
          {(!products)?
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 bg-gray-800">
                {[...Array(placeholderProductCount)].map((_, index) => (
                    <div key={index} className="bg-gray-900 rounded-lg shadow-md p-4 flex flex-col items-center">
                        <div className="w-full h-32bg-gray-600 rounded-md mb-4"></div>
                        <div className="h-4 bg-gray-500 rounded w-3/4 mb-2"></div>
                        <div className="h-4 bg-gray-500 rounded w-1/2"></div>
                    </div>
                ))}
            </div> : <div className="p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 bg-gray-800">
                ...
                <div className="w-full h-32bg-gray-900 rounded-md mb-4">
