...
export default function NavBarHome({ searchProducts }: { searchProducts?: ({ searchTerm }: { searchTerm: string }) => any }) {
    ...
    return (
        <>
            <div className="flex justify-between  items-center bg-gray-800 p-3 shadow-lg border-b border-gray-400 dark:border-gray-700">
                {/* Logo and Title */}
                <div onClick={() => navigate("/home")} className="flex items-center space-x-3 hover:cursor-pointer">
                ...
                <form onSubmit={handleSearch} className="hidden md:flex-grow md:flex justify-streatch items-center ml-16">
